					...
					<div class="panel-body">
						...
						<form method="POST" enctype="multipart/form-data">
								<div class="form-group">
									...
									<input class="form-control" name="TIeuDe" id="TIeuDe" placeholder="Nhập điều luật">
								</div>
								<div class="form-group">
									<label>Phương tiện</label>
									<input class="form-control" name="PhuongTien" id="PhuongTien" placeholder="Nhập điều luật">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
									...
									<input class="form-control" name="MucPhat" id="MucPhat" placeholder="Nhập điều luật">
                                </div>
                                <div class="form-group">
									<label>Nghị định</label>
									<input class="form-control" name="NghiDinh" id="NghiDinh" placeholder="Nhập điều luật">
								</div>
